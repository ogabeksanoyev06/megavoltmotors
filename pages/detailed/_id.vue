  ...
  <div class="py-[40px]">
    <div class="container">
      ...
      >
        <div class="lg:flex-1 flex">
          <swiper class="swiper max-w-[500px]" :options="swiperOptions">
            ...
            >
              <img
                :src="'https://api.uz-megavoltmotors.uz' + image.image"
                alt="Image"
      ...
      <div class="flex flex-wrap gap-10 sm:gap-[50px]">
        <div
          class="w-[100px] h-[100px] flex flex-col items-center justify-center border border-[#4FF4F4] border-[2px] rounded-[100%]"
        >
        ...
        >
          ...
          <span class="text-sm font-semibold text-white">acceleration</span>
        </div>
        <div
          class="w-[100px] h-[100px] flex flex-col items-center justify-center border border-[#4FF4F4] border-[2px] rounded-[100%]"
        >
