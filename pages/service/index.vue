<template>
  <div class="py-[40px]">
    ...
    <div class="container" v-else>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 xs:gap-4 lg:gap-10">
        <div
        ...
        >
          <div
            class="hover:bg-[#00FFFF] ease-out transition-all flex flex-col lg:flex-row w-full bg-[#FBFAFF] rounded lg:gap-10 lg:p-10 p-3"
          >
            <div class="flex flex-col gap-4 flex-1 order-2 lg:order-1">
              <p
                class="xs:text-[14px] lg:text-[20px] text-secondary3 capitalize font-medium"
              >
